...
class DateInput(forms.DateInput):#DateInput is  from django
    input_type = 'date'#will create a date picker from django to validate input

class TripReviewForm(forms.ModelForm):
    class Meta:#class Meta describes infomation about the object
        model = Place#belongs to the Place model
        fields = ('notes', 'date_visited', 'photo')#form has these fields
        widgets = {
            'date_visited': DateInput()#improves ease of user input, add validation?
        }
